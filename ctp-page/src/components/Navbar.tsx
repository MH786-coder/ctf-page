                ...
                <div className="flex items-center gap-6 w-[160px] justify-end">
                    {!isLoggedIn ? (
                        ...
                        <button
                            ...
                            className="text-[#cbd5e1] border border-white/10 bg-black/50 px-5 py-2 rounded-lg hover:border-red-500/50 hover:text-red-400 hover:bg-red-500/10 transition-all text-sm font-bold tracking-wider cursor-pointer"
                        >
                            X TERMINATE
                        </button>
                    )}
