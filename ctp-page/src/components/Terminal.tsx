...
import { Terminal as TerminalIcon, X, ChevronRight, Activity, Cpu, Shield, Clock, Gauge } from 'lucide-react';
...
export default function Terminal() {
    ...
    useEffect(() => {
        window.dispatchEvent(new CustomEvent('ctf_console_toggle', {
            detail: { isOpen }
        }));
    }, [isOpen]);
