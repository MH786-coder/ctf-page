...
export default function ChallengesPage() {
    ...
    const handleFlagSubmit = async () => {
        ...
        try {
            ...
            // Success Updates
            const newCompletedMap = { ...completedMap, [selectedTool.id]: true };
            setCompletedMap(newCompletedMap);
            setSelectedTool(null);

            // Calculate completed count and dispatch custom event
            const completedCount = Object.keys(newCompletedMap).length;
