...
import { UserCircle, Save, Github, Linkedin, Globe, LogOut, Camera, Loader2, Key, Terminal } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-16 pb-20 font-mono">
            ...
            <div className="grid lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-4 flex flex-col gap-8">
                    ...
                    <button
                        ...
                        className="w-full border border-red-500/20 bg-red-500/5 py-4 font-mono text-xs font-bold text-red-500 uppercase tracking-[0.3em] hover:bg-red-500 hover:text-black transition-all flex items-center justify-center gap-3 cursor-pointer"
                    >
            ...
            <LogoutConfirmModal
                ...
                onConfirm={() => supabase.auth.signOut().then(() => router.push('/login'))}
...
function SocialLink({ icon, label, val }: { icon: React.ReactNode, label: string, val: string }) {
    return (
